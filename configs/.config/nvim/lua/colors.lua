...
A.nvim_set_hl(0, "Comment", { ctermfg=7, fg=LightGray })
A.nvim_set_hl(0, "String", { ctermfg=2, fg=Green })
A.nvim_set_hl(0, "Statement", { ctermfg=6, fg=Cyan })
A.nvim_set_hl(0, "Conditional", { ctermfg=6, fg=Cyan })
A.nvim_set_hl(0, "NonText", { ctermfg=9, fg=LightRed })
A.nvim_set_hl(0, "Number", { ctermfg=5, fg=Magenta })
A.nvim_set_hl(0, "Special", { ctermfg=14, fg=LightCyan })
A.nvim_set_hl(0, "Type", { ctermfg=12, fg=LightBlue })
A.nvim_set_hl(0, "PreProc", { ctermfg=9, fg=LightRed })
A.nvim_set_hl(0, "Function", { ctermfg=12, fg=LightBlue })
...
A.nvim_command("highlight Statement ctermfg=Cyan")
